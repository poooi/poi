  ...
  render: ->
    <div className='poi-tabs-container'>
      <div style={display: "flex"}>
        <div style={flex: 2}>
          <TabbedArea activeKey={@state.key[0]} onSelect={@handleSelectLeft} animation={true} style={flex: 1}>
          {
            [
        ...
        <div style={flex: 2}>
          <TabbedArea activeKey={@state.key[1]} onSelect={@handleSelectRight} animation={true} style={flex: 1}>
