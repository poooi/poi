...
export class OverlayTrigger extends React.Component {
  ...
  makeOverlay(overlay, props) {
    return (
      <Overlay
        ...
        target={this}
        container={this.context.overlayMountPoint}
      >
        {overlay}
      </Overlay>
    )
  ...
  render() {
    ...
    return <>
      ...
      { this.state.show && ReactDOM.createPortal(this._overlay, this.context.overlayMountPoint) }
    </>
  }
}
...
OverlayTrigger.contextTypes = contextTypes
