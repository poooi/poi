...
import { map, capitalize, memoize, size, throttle, isString, toUpper } from 'lodash-es'
...
declare const LATEST_COMMIT: string | undefined
...
const openLink = memoize((link: string) => () => void shell.openExternal(link))

const audio = new Audio(`file://${ROOT}/assets/audio/about.mp3`)
const playPoiAudio = throttle(() => void audio.play(), 3000, { trailing: false })
