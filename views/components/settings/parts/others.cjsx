    ...
    <div id='poi-others'>
      <Grid>
        <Col xs={12}>
          ...
          <p>微博: <a onClick={openExternal.bind(@, 'http://weibo.com/letspoi')}> 今天 poi 出新版本了吗 </a></p>
          <p>开发讨论与意见交流群: 378320628 </p>
          <p>poi 掉落数据统计:<a onClick={openExternal.bind(@, 'http://db.kcwiki.moe')}> http://db.kcwiki.moe </a></p>
