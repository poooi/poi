...
| `equipment-improvement` | editing `views/utils/improvement/**`, `assets/data/fcd/improvement.json`, `getTyku` / 制空値 in `views/utils/game-utils.ts`, or `views/components/ship/slotitems-data.ts`; asking what a ★ adds to a stat                |
