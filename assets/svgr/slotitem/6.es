...
const Icon = props => (
  <svg width="1em" height="1em" viewBox="0 0 640 640" {...props}>
    <defs>
      ...
      <linearGradient x1="0%" y1="50%" x2="50%" y2="100%" id="6_svg__d">
    ...
    <g fill="none" fillRule="evenodd">
      <g filter="url(#6_svg__a)" transform="translate(20 45)" fill="#39B74E">
      ...
      <use fill="#000" filter="url(#6_svg__b)" xlinkHref="#6_svg__c" />
      <use fill="url(#6_svg__d)" xlinkHref="#6_svg__c" />
    </g>
  </svg>
)
